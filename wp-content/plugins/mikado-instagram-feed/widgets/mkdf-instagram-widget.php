...
class MikadofInstagramWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array('description' => __('Display instagram images', 'mikado-instagram-feed'))
		);
					...
					<li>
						<div class="mkdf-instagram-item-holder">
							<a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>" target="_blank">
								<?php if(function_exists('voyage_mikado_kses_img')) : ?>
									<?php echo voyage_mikado_kses_img($instagram_api->getHelper()->getImageHTML($image, $image_size)); ?>
								<?php else : ?>
