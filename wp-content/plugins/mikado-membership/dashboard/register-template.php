...
class MikadofMembershipPageTemplate {
	...
	private function __construct() {
		...
		add_filter( 'page_attributes_dropdown_pages_args', array( $this, 'mkdf_membership_register_directory_templates' ) );

		// Add a filter to the save post to inject out template into the page cache
		add_filter( 'wp_insert_post_data', array( $this, 'mkdf_membership_register_directory_templates' ) );
	 ...
	 * @return mixed
	 */
	public function mkdf_membership_register_directory_templates( $atts ) {
